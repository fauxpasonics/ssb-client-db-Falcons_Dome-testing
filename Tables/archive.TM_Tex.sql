...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__CreatedD__214BF109] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_Tex] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_Tex] ([SourceFileName])
GO
