...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Inser__498EEC8D] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Updat__4A8310C6] DEFAULT (getdate()),
...
GO
ALTER TABLE [ods].[TM_Journal] ADD CONSTRAINT [PK__TM_Journ__3213E83FE74A200C] PRIMARY KEY CLUSTERED  ([id])
GO
