...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Inser__18EBB532] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Updat__19DFD96B] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [ods].[TM_HeldSeats] ADD CONSTRAINT [PK__TM_HeldS__3213E83FEB3BB9BD] PRIMARY KEY CLUSTERED  ([id])
GO
