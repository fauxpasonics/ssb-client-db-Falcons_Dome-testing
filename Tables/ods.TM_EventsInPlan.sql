...
[season_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Inser__1CBC4616] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Updat__1DB06A4F] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [ods].[TM_EventsInPlan] ADD CONSTRAINT [PK__TM_Event__3213E83F8FFDB49B] PRIMARY KEY CLUSTERED  ([id])
GO
