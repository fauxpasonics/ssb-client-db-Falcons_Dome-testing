...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Note__InsertD__5AB9788F] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Note__UpdateD__5BAD9CC8] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [ods].[TM_Note] ADD CONSTRAINT [PK__TM_Note__3213E83FDF8239A5] PRIMARY KEY CLUSTERED  ([id])
GO
