...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Journa__Creat__10216507] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_Journal] ([SourceFileName])
GO
