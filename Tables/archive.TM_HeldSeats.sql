...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_HeldSe__Creat__0E391C95] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_HeldSeats] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_HeldSeats] ([SourceFileName])
GO
