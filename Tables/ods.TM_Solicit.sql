...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Inser__7A3223E8] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Updat__7B264821] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [ods].[TM_Solicit] ADD CONSTRAINT [PK__TM_Solic__3213E83F62395BC4] PRIMARY KEY CLUSTERED  ([id])
GO
