...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Creat__17C286CF] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_PriceCode] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_PriceCode] ([SourceFileName])
GO
