...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_CustAddress] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_CustAddress] ([SourceFileName])
GO
