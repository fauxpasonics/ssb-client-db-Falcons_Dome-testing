...
[EventDate] [datetime] NOT NULL CONSTRAINT [DF__EventLog__EventD__534D60F1] DEFAULT (getdate()),
[ExecutionId] [uniqueidentifier] NOT NULL CONSTRAINT [DF__EventLog__Execut__5441852A] DEFAULT (newid()),
