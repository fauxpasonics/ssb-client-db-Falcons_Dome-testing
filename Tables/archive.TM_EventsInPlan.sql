...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Events__Creat__0A688BB1] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_EventsInPlan] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_EventsInPlan] ([SourceFileName])
GO
