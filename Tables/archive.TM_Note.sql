...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Note__Created__13F1F5EB] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_Note] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_Note] ([SourceFileName])
GO
