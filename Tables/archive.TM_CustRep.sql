...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_CustRe__Creat__0880433F] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_CustRep] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_CustRep] ([SourceFileName])
GO
