...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Inser__787EE5A0] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Updat__797309D9] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [ods].[TM_ManifestSeat] ADD CONSTRAINT [PK__TM_Manif__3213E83F5C4D7DE3] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_BusinessKey] ON [ods].[TM_ManifestSeat] ([manifest_id], [section_id], [row_id], [seat_num])
GO
