...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Creat__04AFB25B] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_AvailSeats] ([SourceFileName])
GO
