...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Inser__05D8E0BE] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PromoC__Updat__06CD04F7] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [ods].[TM_PromoCode] ADD CONSTRAINT [PK__TM_Promo__3213E83FAB153005] PRIMARY KEY CLUSTERED  ([id])
GO
