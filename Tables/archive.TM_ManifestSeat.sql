...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Manife__Creat__1209AD79] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_ManifestSeat] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_ManifestSeat] ([SourceFileName])
GO
