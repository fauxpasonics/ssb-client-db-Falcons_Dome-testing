...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Inser__208CD6FA] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_AvailS__Updat__2180FB33] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [ods].[TM_AvailSeats] ADD CONSTRAINT [PK__TM_Avail__3213E83F0B91E718] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_BusinessKey] ON [ods].[TM_AvailSeats] ([event_id], [section_id], [row_id], [seat_num])
GO
