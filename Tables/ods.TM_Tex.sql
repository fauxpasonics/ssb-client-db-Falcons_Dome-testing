...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__InsertDa__245D67DE] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Tex__UpdateDa__25518C17] DEFAULT (getdate()),
...
GO
ALTER TABLE [ods].[TM_Tex] ADD CONSTRAINT [PK__TM_Tex__3213E83FF7694C64] PRIMARY KEY CLUSTERED  ([id])
GO
