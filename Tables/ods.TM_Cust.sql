...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__InsertD__1332DBDC] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__UpdateD__14270015] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL,
[name_type] [nvarchar] (10) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
)
GO
ALTER TABLE [ods].[TM_Cust] ADD CONSTRAINT [PK__TM_Cust__3213E83FA172FC19] PRIMARY KEY CLUSTERED  ([id])
GO
CREATE NONCLUSTERED INDEX [IDX_acct_id] ON [ods].[TM_Cust] ([acct_id])
GO
