...
GO
ALTER TABLE [ods].[TM_AttendApi] ADD CONSTRAINT [PK__TM_Atten__C4EA2445807BCA09] PRIMARY KEY CLUSTERED  ([ETL__ID])
GO
CREATE NONCLUSTERED INDEX [IDX_LoadKey] ON [ods].[TM_AttendApi] ([event_id], [section_id], [row_id], [seat_num])
GO
CREATE NONCLUSTERED INDEX [IDX_result_code] ON [ods].[TM_AttendApi] ([result_code])
GO
