...
[Season_id] [int] NULL,
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__InsertD__0D7A0286] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_Evnt__UpdateD__0E6E26BF] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [ods].[TM_Evnt] ADD CONSTRAINT [PK__TM_Evnt__3213E83F134E117E] PRIMARY KEY CLUSTERED  ([id])
GO
