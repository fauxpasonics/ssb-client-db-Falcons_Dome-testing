...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Tkt__CreatedD__2334397B] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_Tkt] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_Tkt] ([SourceFileName])
GO
