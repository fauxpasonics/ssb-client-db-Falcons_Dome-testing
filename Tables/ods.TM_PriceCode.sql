...
[InsertDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Inser__09A971A2] DEFAULT (getdate()),
[UpdateDate] [datetime] NULL CONSTRAINT [DF__TM_PriceC__Updat__0A9D95DB] DEFAULT (getdate()),
[SourceFileName] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[HashKey] [binary] (32) NULL
)
GO
ALTER TABLE [ods].[TM_PriceCode] ADD CONSTRAINT [PK__TM_Price__3213E83F7359875C] PRIMARY KEY CLUSTERED  ([id])
GO
