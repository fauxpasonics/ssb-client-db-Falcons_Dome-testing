...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Plans__Create__15DA3E5D] DEFAULT (getdate()),
...
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_Plans] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_Plans] ([SourceFileName])
GO
