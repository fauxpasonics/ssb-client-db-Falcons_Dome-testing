...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Solici__Creat__1F63A897] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_Solicit] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_Solicit] ([SourceFileName])
GO
