...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__TM_Cust__Created__0697FACD] DEFAULT (getdate())
)
GO
CREATE NONCLUSTERED INDEX [IDX_CreatedDate] ON [archive].[TM_Cust] ([CreatedDate])
GO
CREATE NONCLUSTERED INDEX [IDX_SourceFileName] ON [archive].[TM_Cust] ([SourceFileName])
GO
